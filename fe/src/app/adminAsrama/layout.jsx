// file: src/app/adminAsr/layout.jsx (SUDAH DIPERBAIKI)
// Halaman layout admin untuk memproteksi rute dan mengelola state global
"use client";
...
export default function DashboardLayout({ children }) {
  ...
  // ===================================================================
  // PERBAIKAN: Pindahkan 'useMemo' ke sini, sebelum 'early return'
  // ===================================================================
  const pageTitle = useMemo(() => {
    if (pathname === "/adminAsr") {
      return "Dashboard";
    }
    // Menggunakan "/adminAsr/" sebagai basis untuk path yang lebih dalam
    const relativePath = pathname.startsWith("/adminAsr/") ? pathname.substring(9) : pathname.split("/").pop();
  ...
  // Blok 'if' untuk loading/auth tetap di sini, setelah semua Hooks dipanggil
  if (isCheckingAuth || !token) {
    return (
      ...
      <div className="lg:pl-64 flex flex-col flex-1">
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8">
          <div className="relative max-w-md mb-6">
            ...
            <input type="text" placeholder="Search something here" className="w-full pl-10 pr-10 py-2 border border-gray-200 rounded-full focus:ring-blue-500 focus:border-blue-500" />
