...
export default function DashboardLayout({ children }) {
  ...
  useEffect(() => {
    if (!isCheckingAuth) {
      // Jika pengecekan selesai dan tidak ada token, atau user bukan TU
      if (!token || (user && (user.slug !== 'pegawai' || user.jabatan !== 'tu'))) {
        router.push('/');
      }
    }
          ...
          <div className="fixed inset-0 flex z-40">
            ...
            >
              <Dialog.Panel className="relative flex-1 flex flex-col max-w-xs w-full bg-gray-800">
                ...
                <SidebarTU setSidebarOpen={setSidebarOpen} />
              </Dialog.Panel>
            </Transition.Child>
